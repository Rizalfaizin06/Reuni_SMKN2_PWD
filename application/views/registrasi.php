                    ...
                    <div class="mt-5">
                        <div>
                            <form action="<?= base_url() ?>Auth/registrasi" method="post">
                                ...
                                <div class="md:flex md:flex-row md:space-x-4 w-full text-xs">
                                    <div class="w-full flex flex-col mb-3">
                                        <label class="font-poppins font-semibold text-gray-600 py-2"> Pekerjaan</label>
                                ...
                                <div class="md:flex flex-row md:space-x-4 w-full text-xs">
                                    <div class="mb-3 space-y-2 w-full text-xs">
                                        ...
                                        <input placeholder="Masukkan namaPerusahaan"
                                            class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded-lg h-10 px-4"
                                            value="<?= (isset($namaPerusahaan)) ? $namaPerusahaan : '' ?>" required
                                            type="text" name="namaPerusahaan" id="namaPerusahaan">
                                        <p class="font-poppins text-red text-xs hidden">Please fill out this field.</p>
                                    </div>
                                </div>
                                <div class="md:flex flex-row md:space-x-4 w-full text-xs">
