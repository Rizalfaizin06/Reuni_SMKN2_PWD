...
<body>
    ...
    <div class="p-5 space-y-4 z-0">

        <h4 class="font-semibold">Menu</h4>
        <div class="grid m-0 grid-cols-2 gap-3 justify-center items-center w-full">
            <div class="bg-gradient-to-r from-cyan-500 to-blue-500 opacity-50 rounded-3xl aspect-square">
                sdgsdkfgjhj
            </div>
            <div class="bg-gradient-to-r from-cyan-500 to-blue-500 opacity-50 rounded-3xl aspect-square">
                sdgsdkfgjhj
        ...
        <div class="grid m-0 grid-cols-2  space-x-4 justify-center items-center w-full ">
            <div
                class="relative flex flex-col justify-between bg-white rounded-3xl  bg-cover text-gray-800  overflow-hidden cursor-pointer w-full object-cover object-center shadow-md h-64 my-2">
                <div class="absolute bg-gradient-to-r from-cyan-500 to-blue-500 opacity-50 inset-0 z-0"></div>
